...
do
	...
	/Users/jdavis/Desktop/projects/lem-in/lem-in_my/generator --big > big$COUNT.txt
	/Users/jdavis/Desktop/projects/lem-in/lem-in_my/lem-in -r < big$COUNT.txt > results_big$COUNT.txt
	# while read line
	# do

...
void				ft_flag_checker(const char *format, t_flag *flag, va_list \
						*arg);
void				ft_specifier_check(const char *format, t_flag *flag, \
						va_list *arg);
...
void				ft_digit_print(char *str, t_flag *flag, int total, \
						va_list *arg);
void				ft_csp_print(const char *format, t_flag *flag, va_list \
						*arg);
void				ft_diu_print(const char *format, t_flag *flag, va_list \
						*arg);
